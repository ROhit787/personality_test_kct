...
export const IntroCard = styled.div.attrs({
  ...
  background: ${colors.$colordiff};
  background: repeating-linear-gradient(135deg, rgba(11, 208, 214, 0.3), transparent 1px, rgba(11, 208, 214, 0.3) 2px);
...
`
export const CreditsCard = styled.div.attrs({
  className: 'card'
})`
  position: fixed;
  height: 20%;
  ...
  box-shadow: 0px -6px 8px 0px rgba(0, 0, 0, 0.1), 0px 6px 8px 0px rgba(0, 0, 0, 0.1),
    6px 0px 8px 0px rgba(0, 0, 0, 0.1), -6px 0px 8px 0px rgba(0, 0, 0, 0.1);
  background: ${colors.$colorCardBgCredit};
  background: repeating-linear-gradient(135deg, rgba(150, 212, 205), transparent 1px, rgba(150, 212, 205) 2px);
  background-size: 3px 3px;
  ${media.tablet`width: 90%;`};
